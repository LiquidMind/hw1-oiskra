...
/** The mention of the gene in sentence
...
public class GeneMention_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("UIMATypes.GeneMention");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("Text", "UIMATypes.GeneMention");
